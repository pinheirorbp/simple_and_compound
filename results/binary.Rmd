...
boxplot(ROB_RESULTS$rob_low_deg[criterium3]~ROB_RESULTS$topology[criterium3], col=COLORS2[c(3,1)], xlab="topology", ylab="robustness", main="removals by degrees")
```
...
```{r, fig.height = 5, fig.width = 5}
boxplot(ROB_RESULTS$rob_low_ran[criterium3]~ROB_RESULTS$topology[criterium3], col=COLORS2[c(3,1)], xlab="topology", ylab="average robustness (1000 extinction sequences)", main="random removals")
```
...
```{r, fig.height = 5, fig.width = 5}
boxplot(ROB_RESULTS$rob_high_deg[criterium3]~ROB_RESULTS$topology[criterium3], col=COLORS2[c(3,1)], xlab="topology", ylab="robustness", main="removals by degrees")
```
...
```{r, fig.height = 5, fig.width = 5}
boxplot(ROB_RESULTS$rob_high_ran[criterium3]~ROB_RESULTS$topology[criterium3], col=COLORS2[c(3,1)], xlab="topology", ylab="mean robustness (1000 extinction sequences)", main="random removals")
```
