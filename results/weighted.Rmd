...
knitr::opts_knit$set(root.dir = "~/Biologia/Projetos/postdoc_unicamp/postdoc 1/compound_topologies")
```
...
MIN=0
#
#source("analysis/aggregation_results_W.R")
# Colors
...
TABLE_RESULTS=read.table(paste("analysis/results/",NAME_OUTPUT,".txt",sep=""), sep="\t", header=T, row.names = 1)
X=read.table(paste("analysis/results/","NETDATA_",NAME_OUTPUT,".txt",sep=""), sep="\t", header=T, row.names = 1)
...
```{r, include=F}
BIN_TABLE_RESULTS=read.table(paste("analysis/results/",BIN_NAME_OUTPUT,".txt",sep=""), sep="\t", header=T)
BIN_X=read.table(paste("analysis/results/","NETDATA_",BIN_NAME_OUTPUT,".txt",sep=""), sep="\t", header=T)
